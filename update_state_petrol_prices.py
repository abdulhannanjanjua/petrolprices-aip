...
from state_scraper import load_prices, merge_latest, save_prices, scrape_latest_state_petrol_prices


BASE_DIR = Path(__file__).resolve().parent
CSV_PATH = BASE_DIR / "data" / "petrol_state_weekly_prices.csv"
XLSX_PATH = BASE_DIR / "data" / "petrol_state_weekly_prices.xlsx"
